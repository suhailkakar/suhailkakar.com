...
const articles = [
  {
    url: "https://x.com/SuhailKakar/status/2005610738149433683",
  ...
  {
    url: "https://x.com/SuhailKakar/status/1948019003810849077",
    title: "crypto's killer app won't be social or finance. it'll be invisible",
  },
  {
    url: "https://x.com/SuhailKakar/status/1937138494088040812",
    title:
      "ai agents will become crypto billionaires faster than any human ever could",
  },
  {
    url: "https://x.com/SuhailKakar/status/1934613020686369204",
    title: "crypto doesn't need more apps. it desperately needs developers",
  },
];
...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col  justify-between max-w-6xl mx-auto px-6 py-12">
      ...
      <footer>
        <nav>
          <p className="text-[var(--muted)] text-md italic mb-3">
            favorite writings:
          </p>
